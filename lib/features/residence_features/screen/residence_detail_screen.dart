...
class _ResidenceDetailScreenState extends State<ResidenceDetailScreen> {
  ...
  @override
  void initState() {
    BlocProvider.of<ResidenceBloc>(context)
        .add(CallResidenceEvent(id: KeySendDataHost.detailId.toString()));
    super.initState();
  }
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            ResidenceCarouselSlider(
                              ...
                              argumentId:
                              KeySendDataHost.detailId.toString(),
                                  ...
                                  SizedBox(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        ResidenceOption(
                                            residenceDetailModel: helperDetail),
                                        //!ResidenceDatePicker
                                        ResidenceDatePicker(
                                          helperDetail: helperDetail,
                                        )
            ...
            return ErrorScreenWidget(
                ...
                function: () {
                  BlocProvider.of<ResidenceBloc>(context).add(
                      CallResidenceEvent(
                          id: KeySendDataHost.detailId.toString()));
                });
          }

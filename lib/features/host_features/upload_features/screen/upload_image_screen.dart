                    ...
                    child: BlocConsumer<ResidenceRegistrationBloc,
                      ...
                      listener: (context, state) {
                        if (state is ResidenceRegistrationCompletedState) {
                          getSnackBarWidget(
                              context, state.success, Colors.green);
                          KeySendDataHost.imageList.clear();
                        ...
                        return ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            if (currentState.images == null ||
                              ...
                              if (KeySendDataHost.isChecking) {
                                BlocProvider.of<ResidenceRegistrationBloc>(
                                        context)
                                    .add(CallResidenceRegistration(
                                        category:
                                            KeySendDataHost.residenceTypeId,
                                        title: KeySendDataHost.residenceName,
                                        description: KeySendDataHost
                                        ...
                                        accommodationAbout: KeySendDataHost
                                            .residenceAdditionalInfo,
                                        options: KeySendDataHost.options,
                                        checkInTime:
                                            KeySendDataHost.checkInTime,
                                        checkOutTime:
                                            KeySendDataHost.checkOutTime,
                                        regulations:
                                            KeySendDataHost.regulations,
                                ...
                                //print("HosseinJahanfar");
                                // print(KeySendDataHost.typeParking);
                                // print(KeySendDataHost.titleParking);
                                // print(KeySendDataHost.descriptionParking);
                                // print(KeySendDataHost.capacityParking);
                                // print(KeySendDataHost.priceParking);
                                // print(KeySendDataHost.isCheckedParking);
                                // print(KeySendDataHost.provinceParking);
                                // print(KeySendDataHost.lat);
                                // print(KeySendDataHost.long);
                                // print(KeySendDataHost.cityParking);
                                // print(KeySendDataHost.addressParking);
                                BlocProvider.of<ResidenceRegistrationBloc>(
                                        context)
                                    .add(CallParkingRegistrationEvent(
                                        typeParking:
                                            KeySendDataHost.typeParking,
                                        title: KeySendDataHost.titleParking,
                                        description:
                                            KeySendDataHost.descriptionParking,
                                        address: KeySendDataHost.addressParking,
                                        capacity: KeySendDataHost.cityParking,
                                        province:
                                            KeySendDataHost.provinceParking,
                                        city: KeySendDataHost.cityParking,
                                        lat: KeySendDataHost.lat,
                                        long: KeySendDataHost.long,
                                        isCheckingParking:
                                            KeySendDataHost.isCheckedParking,
                                        price: KeySendDataHost.priceParking,
                                        imageList: KeySendDataHost.imageList));
                              }
                            }
                          },
